  ...
  return (
    <div className="container-custom py-20">
      ...
      <div className="space-y-8">
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2">What is AuraSync Fashion?</h2>
          <p className="text-primary/80">AuraSync Fashion is an online platform dedicated to helping you discover and express your unique fashion personality through carefully curated pieces.</p>
        </div>
