...
export default function MaleRecommendationsPage() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-black text-white">
      ...
      <div className="pt-20 px-6 max-w-7xl mx-auto">
        <div className="mb-6 flex items-center justify-between">
          <h1 className="text-3xl md:text-4xl font-bold">Male Recommendations</h1>
          <button
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {products.map((p, idx) => (
              ...
              >
                ...
                <div className="mt-3 w-full text-center bg-blue-600 text-white rounded-lg py-2">View on Amazon</div>
              </a>
            ))}
          </div>
        )}
