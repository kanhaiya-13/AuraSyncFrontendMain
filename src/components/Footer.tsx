...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-[#1a1a1a] relative">
      ...
      <div className="relative w-full bg-[#333333] rounded-t-[40px] pt-10 pb-6 sm:pt-12 sm:pb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-20 lg:gap-24 xl:gap-28 mb-20">
            ...
            <div className="space-y-8">
              ...
              <ul className="space-y-6">
                ...
                <li>
                  <Link href="/analysis-v2/force" className="text-gray-300 hover:text-white transition-colors text-base">
                    Features
                  </Link>
                </li>
                <li>
            ...
            <div className="space-y-8">
              ...
              <ul className="space-y-6">
                <li>
                  <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors text-base">
                    Instagram
                  </a>
                </li>
                <li>
                  <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors text-base">
                    Linkedin
                  </a>
                </li>
                <li>
            ...
            <div className="space-y-8">
              <div className="flex items-center mb-8">
                <h3 className="text-white font-semibold text-xl mr-3">Contact Us</h3>
                <FaComments className="text-white text-xl" />
              </div>
              <div className="space-y-7">
                <div className="flex items-start">
                  <FaMapMarkerAlt className="text-gray-300 mt-1 mr-4 flex-shrink-0 text-base" />
                  <span className="text-gray-300 text-base">Mumbai 400 015, Maharashtra India</span>
                </div>
                <div className="flex items-center">
                  <FaEnvelope className="text-gray-300 mr-4 flex-shrink-0 text-base" />
                  <span className="text-gray-300 text-base">auraasync@gmail.com</span>
                </div>
              </div>
            </div>
        ...
        <div className="relative z-10 text-center">
          <h1 className="text-8xl lg:text-9xl font-bold text-[#555555] leading-none tracking-tight">
            AuraaSync
          </h1>
        </div>
      </div>
